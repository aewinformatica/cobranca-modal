...
public class Titulo {
	...
	@NotNull(message="Data de  Vencimento Obrigatoria!")
	@DateTimeFormat(pattern = "dd/MM/yyyy")
	@Temporal(TemporalType.DATE)
	private Date dataVencimento;
		
	@NotNull(message="Valor é Obrigatorio")
	@DecimalMin(value="0.01", message = "Valor minimo é 0,01")
	@DecimalMax(value="9999999.99", message = "Valor maximo é 9.999.999,99")
